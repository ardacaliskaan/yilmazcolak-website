// app/admin/team/[id]/edit/page.js - Ekip Üyesi Düzenleme Sayfası
'use client';
...
export default function EditTeamMember() {
  ...
  const handleInputChange = (e) => {
    ...
    if (name === 'name') {
      // İsim değiştiğinde slug'ı otomatik güncelle (sadece boş ise)
      setFormData(prev => ({
        ...prev,
        [name]: value,
  ...
  // Eğitim ekleme/çıkarma/güncelleme
  const addEducation = () => {
    setFormData(prev => ({
      ...prev,
  ...
  if (notFound) {
    return (
      <div className="text-center py-12">
        ...
        <h2 className="text-2xl font-bold text-gray-900 mb-2">Ekip Üyesi Bulunamadı</h2>
        <p className="text-gray-600 mb-6">Aradığınız ekip üyesi mevcut değil veya silinmiş olabilir.</p>
        <Link
          href="/admin/team"
          className="inline-flex items-center space-x-2 px-4 py-2 bg-amber-500 text-white rounded-lg hover:bg-amber-600 transition-colors duration-200"
        >
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-4">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-900">Ekip Üyesi Düzenle</h1>
            <p className="text-gray-600">
              {formData.name ? `${formData.name} bilgilerini düzenleyin` : 'Ekip üyesi bilgilerini düzenleyin'}
            </p>
          </div>
        </div>
      </div>
      ...
      {/* Form - Aynı yapı create sayfası ile aynı, sadece başlık ve submit farklı */}
      <form onSubmit={handleSubmit} className="space-y-8">
        ...
        {/* Eğitim - Aynı yapı ama mevcut data ile */}
        <div className="bg-white rounded-xl border border-gray-200 p-6">
